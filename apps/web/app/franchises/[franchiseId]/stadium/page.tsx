...
export default async function StadiumPage({params}:{params:Promise<{franchiseId:string}>}) {
  ...
  return <main>
    ...
    <section className="panel"><p className="eyebrow">STADIUM VIEW</p><h2>{abbr} Neon Dome</h2><p className="lede">Your franchise history lives here. Wins, rivalries and championships permanently change the environment.</p>
      <div className="stadiumScene" style={{'--team-primary':primary,'--team-secondary':secondary} as React.CSSProperties}>
        <div className="stadiumSky" aria-hidden="true"/><div className="stadiumBowl" aria-hidden="true"/><div className="stadiumCrowd" aria-hidden="true"/><div className="stadiumLight stadiumLightLeft" aria-hidden="true"/><div className="stadiumLight stadiumLightRight" aria-hidden="true"/>
