...
export default function BigExecAppHeader({leagueId,isCommissioner=false,voiceGmEnabled=false}:{leagueId:string;isCommissioner?:boolean;voiceGmEnabled?:boolean}){
  ...
  return <header className="bigExecAppHeader">
    ...
    <div className="actions">
      {voiceGmEnabled&&<AskGmPushToTalk />}
