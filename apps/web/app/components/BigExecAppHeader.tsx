...
export default function BigExecAppHeader({leagueId,isCommissioner=false}:{leagueId:string;isCommissioner?:boolean}){
  ...
  return <header className="bigExecAppHeader">
    ...
    <div className="actions">
      {isCommissioner&&<a className="secondary" href={`/leagues/${leagueId}/settings/roster-integrity`}>Roster Integrity</a>}
