...
export default function BigExecAppHeader({leagueId,isCommissioner=false,voiceGmEnabled=false,voiceInputEnabled=true,criticalControlsActive=false}:{leagueId:string;isCommissioner?:boolean;voiceGmEnabled?:boolean;voiceInputEnabled?:boolean;criticalControlsActive?:boolean}){
  ...
  return <header className="bigExecAppHeader">
    ...
    <div className="actions">
      {voiceGmEnabled&&<AskGmPushToTalk onAsk={(question)=>askHeaderAssistantGm(leagueId,question)} voiceInputEnabled={voiceInputEnabled} capabilities={{voiceInput:voiceInputEnabled,spokenOutput:true,criticalControlsActive}} />}
